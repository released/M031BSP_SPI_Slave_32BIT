...
// SPI master
#define MasterSpiPortNum				(USPI0)
#define SPI_TARGET_FREQ					(800000ul)
#define SPI_DATA_NUM					(1)
uint32_t g_au32MasterTxBuffer = 0;
uint32_t g_au32MasterRxBuffer = 0;
...
extern uint8_t g_au8SlaveRxFlag;
extern uint32_t g_au32SlaveTxBuffer;
extern uint32_t g_au32SlaveRxBuffer;
...
//    CLK_WaitClockReady(CLK_STATUS_LXTSTB_Msk);	
	...
	*/
    ...
    // SYS->GPD_MFPL |= (SYS_GPD_MFPL_PD1MFP_SPI0_MISO);	
